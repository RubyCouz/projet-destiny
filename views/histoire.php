<?php
 include 'header.php';
?>
<div class="js-scrollTo" id="home">
    <div class="row">
        <ul class="tabs tabs-fixed-width">
            <li class="tab col s12"><a href="#story">Histoire</a></li>
            <li class="tab col s12"><a href="#referencies">Références culturelles</a></li>
        </ul>
    </div>
    <!-- contenu hitoire -->
    <div id="story">
        ...
        <div class="container">
            <div class="row section scrollspy">
                <div class="col s12 m12 l12">
                    <h3><strong>Histoire de Destiny</strong></h3>
                    <h3><strong>Avant l'Age d'Or</strong></h3>                    
                    <p>
                    ...
                    <h3><strong>L'Age d'Or</strong></h3>                    
                    <p>
    ...
    <div id="referencies">
        <div class="container">
            <div class="row section scrollspy">
                <div class="col s12 m12 l12">
                    <h3><strong>Références culturelles</strong></h3>
                    <h3>lorem ipsum</h3>
                    <p>            

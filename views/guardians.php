...
<div id="home" class="js-scrollTo">
    <div class="row">
        <ul class="tabs tabs-fixed-width">
            <li class="tab col s12"><a href="#titan">Titan</a></li>
            <li class="tab col s12"><a href="#warlock">Arcaniste</a></li>
            <li class="tab col s12"><a href="#hunter">Chasseur</a></li>
            <!--            <li class="tab col s3"><a href="#pnj">Autres P.N.J</a></li>-->
        </ul>
    </div>

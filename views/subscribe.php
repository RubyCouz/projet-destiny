<?php
 ...
 include '../models/u01cc_users.php';
        ...
        <?php
         ...
         else
         {
             ...
             <div class="container content">
                 ...
                 <div class="row">
                     <form action="subscribe.php" method="POST" class="col s12 m12 l12">
                         <div class="row">
                             <div class="col s12 m12 l6 input-field">
                                 <label for="lastname"><?= REGISTER_LASTNAME ?> :</label>
                                 <input type="text" id="lastname" name="lastname" value="<?= isset($_POST['submit']) ? $addUser->lastname : '' ?>" class="" />
                                 <small class="error"><?= isset($formError['lastname']) ? $formError['lastname'] : '' ?></small>
                             </div>
                             <div class="col s12 m12 l6 input-field">
                                 <label for="firstname"><?= REGISTER_FIRSTNAME ?> :</label>
                                 <input type="text" id="firstname" name="firstname" value="<?= isset($_POST['submit']) ? $addUser->firstname : '' ?>" class="" />
                                 <small class="error"><?= isset($formError['firstname']) ? $formError['firstname'] : '' ?></small>                             </div>
                         </div>
                         <div class="row">
                             <div class="col s12 m12 l6 input-field">
                             ...
                             <div class="col s12 m12 l6 input-field">
                                 ...
                                 <input type="email" id="email" name="email" value="<?= isset($_POST['submit']) ? $addUser->email : '' ?>" class="" />
                                 <small class="error"><?= isset($formError['email']) ? $formError['email'] : '' ?></small>                             </div>
                         </div>
                         <div class="row">
                             <div class="col s12 m12 l6 input-field">
                                 <select name="console">
                                     <option value="" disabled selected>Choissez votre plate-forme</option>
                             ...
                             <div class="col s12 m12 l6 input-field">
                                 ...
                                 <input type="text" id="gamerTag" name="gamerTag" value="<?= isset($_POST['submit']) ? $addUser->gamerTag : '' ?>" class="" />
                         ...
                         <div class="row">
                             <div class="col s12 m12 l6 input-field">
                                 ...
                                 <input type="password" id="password" name="password" value="<?= isset($_POST['submit']) ? $addUser->password : '' ?>" class="" />
                             ...
                             <div class="col s12 m12 l6 input-field">
                                 ...
                                 <input type="password" id="confirmPassword" name="confirmPassword" value="<?= isset($_POST['submit']) ? $addUser->confirmPassword : '' ?>" class="" />
                         ...
                         <div class="row right-align">
                             <div class="col s12 m12 l12">
                                 <a class="modal-trigger" href="#modal1"><input type="submit" name="submit" class="waves-effect waves-dark btn" value="<?= REGISTER_SIGNIN ?>" /></a>
                             </div>
                         </div>
                     </form>
                 </div>

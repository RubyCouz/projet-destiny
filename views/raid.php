...
<div class="row">
    <div class="col s12">
        <ul class="tabs">
            <li class="tab col s1"><a href="#door">Ouverture de la porte</a></li>
            <li class="tab col s2"><a href="#defense">Défense de la déchirure</a></li>
            <li class="tab col s2"><a href="#destruct">destruction des oracles</a></li>
            <li class="tab col s2"><a href="#templier">Le Templier</a></li>
            <li class="tab col s2"><a href="#labyrinthe">Le Labyrinthe des Gorgones</a></li>
            <li class="tab col s2"><a href="#keyMaster">Le Maître des clés</a></li>
            <li class="tab col s1"><a href="#atheon">Athéon</a></li>
        </ul>
    </div>
    <div id="door">
